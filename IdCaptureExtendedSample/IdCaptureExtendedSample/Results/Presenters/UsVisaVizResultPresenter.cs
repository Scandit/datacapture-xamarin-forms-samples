...
namespace IdCaptureExtendedSample.Results.Presenters
{
    public class UsVisaVizResultPresenter : IResultPresenter
    {
        ...
        private IList<ResultEntry> GetRows(CapturedId capturedId)
        {
            var usVisaVizResult = capturedId.UsVisaViz;

            ResultEntry[] rows = new ResultEntry[] {
                new ResultEntry(value: usVisaVizResult.PassportNumber, title: "Passport number"),
                new ResultEntry(value: usVisaVizResult.VisaNumber, title: "Visa number"),
            };
