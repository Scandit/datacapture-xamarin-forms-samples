    ...
    public class UsUniformedServicesResultPresenter : IResultPresenter
    {
        ...
        private IList<ResultEntry> GetUsUniformedServicesBarcodeRows(UsUniformedServicesBarcodeResult usUniformedServicesResult)
        {
            var usUniformedServicesBarcodeRows = new[] {
                ...
                new ResultEntry(value: usUniformedServicesResult.ChampusEffectiveDate?.LocalDate.ToString(), title: "Champus Effective Date"),
                new ResultEntry(value: usUniformedServicesResult.ChampusExpiryDate?.LocalDate.ToString(), title: "Champus Expiry Date"),
